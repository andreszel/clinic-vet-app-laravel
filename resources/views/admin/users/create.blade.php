...
@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Nowy użytkownik</h1>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('users.store') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input value="{{ old('email') }}" id="email" name="email" placeholder="Wpisz email" type="text" class="form-control" required="required">
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input value="{{ old('phone') }}" id="phone" name="phone" placeholder="Wpisz telefon" type="text" class="form-control" required="required">
                    @error('phone')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        <input value="{{ $commission_medicals }}" id="commission_medicals" name="commission_medicals" placeholder="Wpisz wysokość prowizji" type="number" class="form-control" required="required">
                        <div class="input-group-append">
                            <div class="input-group-text">%</div>
                        </div>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select id="type_id" name="type_id" required="required" class="custom-select">
                        ...
                        <option value="{{ $type->id }}" {{ $type->default_selected ? 'selected="selected"' : '' }}>{{ $type->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
