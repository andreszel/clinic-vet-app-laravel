    ...
    <div class="card-body">
        <form method="POST" action="{{ route('additionalservices.store') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-2">
                    <div class="input-group">
                        <input value="{{ old('nightly_gross_price') }}" id="nightly_gross_price" name="nightly_gross_price" placeholder="Wpisz stawkę nocną brutto" type="text" class="form-control">
                        <div class="input-group-append">
                            <div class="input-group-text">PLN</div>
                        </div>
                    </div>
                ...
                <div class="col-md-9">
                    <div class="custom-controls-stacked">
                        <div class="custom-control custom-radio">
                            <input name="set_price_in_visit" id="set_price_in_visit_1" type="radio" required="required" class="custom-control-input" value="1">
                            <label for="set_price_in_visit_1" class="custom-control-label">Tak</label>
                        </div>
                    </div>
                    <div class="custom-controls-stacked">
                        <div class="custom-control custom-radio">
                            <input name="set_price_in_visit" id="set_price_in_visit_0" type="radio" required="required" class="custom-control-input" value="0" checked="checked">
